...
print('1Round Player1 카드 정보 >>>')
player1.get_card_info()
print('>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<')

print('1Round Player2 카드 정보 >>>')
player2.get_card_info()
print('>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<')

print('1Round Player3 카드 정보 >>>')
player3.get_card_info()
print('>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<')

HoldemPlayer.set_card3('DiaK')
#객체 전부에 해당(혹은 객체가 아직 안 만들어졌으니까)하니까
#class 이름(HoldemPlayer)로 호출



print('2Round Player1 카드 정보 >>>')
player1.get_card_info()
print('>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<')

print('2Round Player2 카드 정보 >>>')
player2.get_card_info()
print('>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<')

print('2Round Player3 카드 정보 >>>')
player3.get_card_info()
print('>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<')
